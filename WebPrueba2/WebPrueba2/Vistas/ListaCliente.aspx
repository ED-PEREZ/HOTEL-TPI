                        ...
                        <div class="col-lg-12"> 
                            <form id="form" runat="server">
                                <asp:GridView ID="gvTipo"  class="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="False"    >
                                    <Columns>   
                                        <asp:BoundField DataField="nombre" HeaderText="Numero de Habitacion #" />
                                        <asp:BoundField DataField="dui" HeaderText="Estado" />
                                        ...
                                        <asp:BoundField DataField="correo" HeaderText="Numero de Habitacion #" />
                                        <asp:BoundField DataField="celular" HeaderText="Estado" />
                                        <asp:TemplateField HeaderText="Opciones">
                                        <ItemTemplate>                            
                                            <button class="btn btn-info"><a  class="fa fa-pencil" style="color:#0E0D0D;" href="EditarCliente.aspx?id=<%# Eval("idcliente") %>" ></a></button>
                                        </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                 </asp:GridView> 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuscarCatalogo.aspx.cs" Inherits="WebPrueba2.Vistas.BuscarCatalogo" %>
                            ...
                            <form id="form" runat="server">
                                <asp:GridView ID="gvTipo"  class="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="False"    >
                                    <Columns>   
                                        ...
                                        <ItemTemplate>    
                                            <button type="button" class="btn btn-primary" onclick="selecciona('<%# Eval("descripcion") %>','<%# Eval("idcatalogo") %>')" >Retornar</button>
                                        </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                 </asp:GridView> 

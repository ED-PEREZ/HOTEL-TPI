<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Menu.Master" AutoEventWireup="true" CodeBehind="AgregarCatalogo.aspx.cs" Inherits="WebPrueba2.Vistas.AgregarCatalogo" %>
    ...
    <script type="text/javascript" >
        ...
        function datosCorrectos() {
            Swal({
             ...
             setTimeout ("document.location.href = 'AgregarCatalogo.aspx'",1500);
        }
    </script>
</asp:Content>
